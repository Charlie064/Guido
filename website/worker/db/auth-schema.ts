...
export const account = sqliteTable(
  "account",
  {
    ...
    // better-auth 1.7.x's account model (@better-auth/core/dist/db/get-tables.mjs),
    // newer than what `@better-auth/cli generate` (stuck at 1.5.0-beta)
    // knows to emit; added by hand after a local sign-up 500'd on it.
