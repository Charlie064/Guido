...
// "download" dropped from here for now — no #download anchor exists while
// the download CTA is hidden (see Landing()'s comment below). Add back
// alongside the button. See docs/planning/glass-waitlist-integration.md.
  ...
  return (
    <div className="min-h-screen text-[#0A0A0A]" style={{ background: "#ffffff", fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Nav — links stay laptop-only (`site-nav`). Phone keeps logo + CTA.
          Download button hidden for now: no onDownload prop passed, see
      ...
      <section id="waitlist" className="max-w-6xl mx-auto px-5 sm:px-6 py-12 sm:py-16 text-center scroll-mt-16">
        ...
        {/* Download CTA hidden for now (paired button dropped alongside
            SiteHeader's) — see docs/planning/glass-waitlist-integration.md. */}
