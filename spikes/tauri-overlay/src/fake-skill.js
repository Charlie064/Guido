...
// image_height} Box2D that locate_element already returns (see
// src-tauri/src/lib.rs) — this fixture just plays the role of "the
// vision/plan call already ran and here's its result", so main.js's
// overlay renderer (see the tutoria:show-overlay listener in main.js)
// doesn't know or care whether a box came from a live call or a fixture.
// image_width/image_height are the reference resolution the coordinates
// were produced at — the renderer scales into whatever the real monitor
// is, the same problem a live vision call would also have to solve.
//
...
function bbox(x0, y0, x1, y1) {
  return { x0, y0, x1, y1, image_width: REF_W, image_height: REF_H };
}
